from shared_utilities.constants import DATA_FOLDER, RESOURCES_FOLDER
...
RESOURCE_DICTIONARIES_FOLDER = f"{RESOURCES_FOLDER}/dictionaries"

DICTIONARY_TO_PATH = {
    DICTIONARY.CUSTOM_DICTIONARY: f"{DATA_FOLDER}/{DICTIONARY.CUSTOM_DICTIONARY}",
    DICTIONARY.FORBIDDEN_DICTIONARY: f"{DATA_FOLDER}/{DICTIONARY.FORBIDDEN_DICTIONARY}",
    ...
    DICTIONARY.SMALL_DICTIONARY: RESOURCE_DICTIONARIES_FOLDER,
}
